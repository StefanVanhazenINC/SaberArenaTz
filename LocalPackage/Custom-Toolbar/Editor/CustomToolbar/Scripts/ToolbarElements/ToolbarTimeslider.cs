...
internal class ToolbarTimeslider : BaseToolbarElement {
	[SerializeField] bool updateTime = false;
	...
	protected override void OnDrawInToolbar() {
		...
		updateTime = EditorGUILayout.Toggle(new GUIContent(""), updateTime, GUILayout.Width(15));
        selectedTimeScale = EditorGUILayout.Slider("", selectedTimeScale, minTime, maxTime, GUILayout.Width(WidthInToolbar - 30.0f));
        if (EditorApplication.isPlaying && selectedTimeScale != Time.timeScale && updateTime)
